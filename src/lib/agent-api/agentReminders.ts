import {
  ...
  type CreateReminderApiInput,
  type ReminderMutationResult,
  type UpdateReminderApiInput,
...
export async function createReminder(
  ...
  try {
    ...
    return data as ReminderMutationResult;
  } catch (error) {
    if (audit?.enabled) {
...
export async function completeReminder(
  context: AgentApiContext,
  input: Pick<UpdateReminderApiInput, 'reminder_id'>,
  audit?: AgentAuditContext
) {
