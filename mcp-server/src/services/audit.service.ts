import { agentActionInputSchema, type AgentActionInput, type AgentServerContext } from './types.js';

export async function logAgentAction(context: AgentServerContext, input: AgentActionInput) {
...
export async function tryLogAgentFailure(
